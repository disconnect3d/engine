...
void LFX_ParticleEffect200X (int effect, vec3_t org, vec3_t dir)
{
	...
	if (effect == 1)
		{
			colory[0] = 0.7; colory[1] = 0.7; colory[2] = 0.7; colory[3] = 1.0;
			colory2[0] = 0.5; colory2[1] = 0.5; colory2[2] = 0.5; colory2[3] = 0.8;
			colory3[0] = 0.5; colory3[1] = 0.4; colory3[2] = 0.3; colory3[3] = 0.5;
			colory4[0] = 0.5; colory4[1] = 0.4; colory4[2] = 0.3; colory4[3] = 0.0;
	...
	if (effect == 6)
		{
			colory[0] = 1.0; colory[1] = 0.7; colory[2] =  1.0; colory[3] = 0.0;
			colory2[0] = 0.3; colory2[1] = 0.7; colory2[2] = 1.0; colory2[3] = 0.5;
			colory3[0] = 0.1; colory3[1] = 0.2; colory3[2] = 0.6; colory3[3] = 0.8;
			colory4[0] = 0.0; colory4[1] = 0.0; colory4[2] = 0.0; colory4[3] = 0.0;
			VectorMA( origin, 1, dir, sprOrg );
			VectorScale( dir, 7, sprVel );
			R_LFX_Smoke2 (sprOrg, sprVel, 2 + (random()*6), 6.54+ (random()*8.7), colory, colory2, colory3, colory4, colory4, 1, 800 + (random()*2000), 2, 8+ (random()*6), 0);
	...
	if (effect == 14 && !com_blood->integer)
		{
			...
			colory[0] = 0.0; colory[1] = 0.7; colory[2] = 1.0; colory[3] = 0.0;
			colory2[0] = 0.0; colory2[1] = 0.0; colory2[2] = 1.0; colory2[3] = 0.5;
			colory3[0] = 0.0; colory3[1] = 0.0; colory3[2] = 0.6; colory3[3] = 0.8;
			colory4[0] = 0.0; colory4[1] = 0.0; colory4[2] = 0.0; colory4[3] = 0.0;
	...
	if (effect == 19)
		{
			colory[0] = 1.0; colory[1] = 1.0; colory[2] = 1.0; colory[3] = 1.0;
			colory2[0] = 0.3; colory2[1] = 0.5; colory2[2] = 0.6; colory2[3] = 0.6;
			colory3[0] = 0.1; colory3[1] = 0.2; colory3[2] = 0.3; colory3[3] = 0.3;
			colory4[0] = 0.0; colory4[1] = 0.0; colory4[2] = 0.0; colory4[3] = 0.0;
